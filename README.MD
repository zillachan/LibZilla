[![Build Status](https://travis-ci.org/zillachan/LibZilla.svg?branch=master)](https://travis-ci.org/zillachan/LibZilla)
...
dependencies {
        compile 'com.github.zillachan:libzilla:1.1.4'
}
