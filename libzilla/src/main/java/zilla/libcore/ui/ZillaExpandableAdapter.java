...
public class ZillaExpandableAdapter<T, Child> extends BaseExpandableListAdapter {
    ...
    private ZillaAdapter.ZillaAdapterButtonClickListener zillaAdapterButtonClickListener;

    protected IZillaAdapterCallback iZillaAdapterCallback;

    public ZillaAdapter.ZillaAdapterButtonClickListener getZillaAdapterButtonClickListener() {
        return zillaAdapterButtonClickListener;
    }

    public void setZillaAdapterButtonClickListener(ZillaAdapter.ZillaAdapterButtonClickListener zillaAdapterButtonClickListener) {
